...
'''
def encode(txt_file, cover_file_name, output_name):
    # start encode
...
if __name__ == "__main__":
    txt_file = "t.txt"
    cover_file_name = "cover_txt.txt"
    output_name = "new_txt.txt"

    encode(txt_file, cover_file_name, output_name)
    decode(output_name, "decode_txt.txt")